...
var Reservations = {
	...
	footerResaEnCours: function () {
		...
		document.getElementById("bouton_annulation_resa").style.display = "block";
		document.getElementById("text_current_resa").style.display = "block";
	...
	finResa:function () {
		...
		document.getElementById("bouton_annulation_resa").style.display = "none";
		document.getElementById("text_current_resa").style.display = "none";
